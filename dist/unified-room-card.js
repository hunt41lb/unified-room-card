...
`;function de(t){return t&&"none"!==t?`animation-${t}`:""}let he=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
