...
`;function de(t){return t&&"none"!==t?`animation-${t}`:""}let he=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
    ...
    `:G}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state),i=!1!==this._config?.show_icon,s=this._config?.show_img_cell??!0,n=this._config?.icon||this._getDefaultIcon(t),a={"icon-container":!0,"with-img-cell":s,active:e,[de(this._config?.animate_icon&&e?"pulse":void 0)]:!0},o={};if(e&&s){const e=this._getEntityBackgroundColor(t);o["background-color"]=e,o.background=e}const r={};if(this._config?.icon_size&&(r["--mdc-icon-size"]=this._config.icon_size),e&&s)r.color="var(--text-primary-color, #fff)";else if(t){const e=this._getEntityStateColor(t);e&&(r.color=e)}const c={};switch(this._config?.icon_horizontal_position||Nt){case jt:c["justify-self"]="start";break;case Ot:c["justify-self"]="center";break;default:c["justify-self"]="end"}switch(this._config?.icon_vertical_position||Rt){case Rt:c["align-self"]="start";break;case Mt:c["align-self"]="center";break;case It:c["align-self"]="end"}return W`
      <div class="icon-section" style=${yt(c)}>
