...
`;function Bt(t){return t&&"none"!==t?`animation-${t}`:""}let Lt=class extends dt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1}}setConfig(t){this._config=t}render(){return this.hass&&this._config?q`
    ...
    `:F}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.state),i=!1!==this._config?.show_icon,s=this._config?.icon||this._getDefaultIcon(t),n={"icon-container":!0,"with-img-cell":this._config?.show_img_cell??!0,active:e,[Bt(this._config?.animate_icon&&e?"pulse":void 0)]:!0},o={};return this._config?.icon_size&&(o["--mdc-icon-size"]=this._config.icon_size),q`
    ...
    `}_renderClimateSection(){return this._config?.climate_entities||this._config?.power_entities?q`
