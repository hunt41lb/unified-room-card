...
`;function de(t){return t&&"none"!==t?`animation-${t}`:""}let he=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
    ...
    `:G}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state),i=!1!==this._config?.show_icon,s=this._config?.show_img_cell??!0,n=this._config?.icon||this._getDefaultIcon(t),a=t?this._getDomain(t.entity_id):"",o={"icon-container":!0,"with-img-cell":s,active:e,[de(this._config?.animate_icon&&e?"pulse":void 0)]:!0},r={};if(e&&s){const e=this._getEntityBackgroundColor(t);r["background-color"]=e,r.background=e}const c={};if(this._config?.icon_size&&(c["--mdc-icon-size"]=this._config.icon_size),e&&s)c.color="var(--text-primary-color, #fff)";else if(t&&e)if("light"===a)c.color="var(--state-light-active-color, var(--amber-color, #ffc107))";else if("climate"===a){const e=this._getEntityStateColor(t);e&&(c.color=e)}else{const e=this._getEntityStateColor(t);c.color=e||"var(--state-active-color, var(--amber-color, #ffc107))"}else if(t){const e=this._getEntityStateColor(t);e&&(c.color=e)}const l={};switch(this._config?.icon_horizontal_position||Nt){case jt:l["justify-self"]="start";break;case Ot:l["justify-self"]="center";break;default:l["justify-self"]="end"}switch(this._config?.icon_vertical_position||Rt){case Rt:l["align-self"]="start";break;case Mt:l["align-self"]="center";break;case Dt:l["align-self"]="end"}return W`
