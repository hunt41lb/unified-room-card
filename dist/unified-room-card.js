...
`,Ht=c`
  ...
  ha-switch {
    --mdc-theme-secondary: ${r(Ot)};
  }
`;function It(t){return t&&"none"!==t?`animation-${t}`:""}let Dt=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
