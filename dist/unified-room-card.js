...
`;function ue(t){return t&&"none"!==t?`animation-${t}`:""}let me=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1,this._customColorInputs=new Set}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
    ...
    `}_renderPersistentEntityConfig(t,e){const i=t.entity||"",s=i&&this.hass?.states[i],a=i?i.split(".")[0]:"",o=ne.includes(a);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._persistentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const s=`${e}-${i}`,a=t.color||"",o=this._customColorInputs.has(s)||a&&!Rt.some(t=>t.value===a),n=o?"custom":a;return G`
    ...
    `}_renderIntermittentSection(){const t=this._accordionState.intermittent;return G`
      <div class="accordion">
        <div
          class="accordion-header ${t?"expanded":""}"
    ...
    `}_renderBatterySection(){const t=this._accordionState.battery;return G`
      <div class="accordion">
        <div
          class="accordion-header ${t?"expanded":""}"
    ...
    `}_renderUpdateSection(){const t=this._accordionState.update;return G`
      <div class="accordion">
        <div
          class="accordion-header ${t?"expanded":""}"
    ...
    `}_toggleAccordion(t){this._accordionState={...this._accordionState,[t]:!this._accordionState[t]}}_valueChanged(t,e){if(!this._config)return;const i={...this._config,[t]:e};""!==e&&null!=e||delete i[t],this._config=i,this._dispatchConfigChanged()}_gridValueChanged(t,e){if(!this._config)return;const i={...this._config.grid}||{};e?i[t]=e:delete i[t],this._config={...this._config,grid:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_tapActionChanged(t,e){if(!this._config)return;const i={...this._config,[t]:{action:e}};this._config=i,this._dispatchConfigChanged()}_tapActionDataChanged(t,e,i){if(!this._config)return;const s=this._config[t]||{action:"none"},a={...this._config,[t]:{...s,[e]:i||void 0}};i||delete a[t][e],this._config=a,this._dispatchConfigChanged()}_climateValueChanged(t,e){if(!this._config)return;const i={...this._config.climate_entities}||{};Array.isArray(e)&&0===e.length||""===e||null==e?delete i[t]:i[t]=e,this._config={...this._config,climate_entities:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_powerValueChanged(t,e){if(!this._config)return;const i={...this._config.power_entities}||{};Array.isArray(e)&&0===e.length||""===e||null==e?delete i[t]:i[t]=e,this._config={...this._config,power_entities:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_persistentValueChanged(t,e){if(!this._config)return;const i={...this._config.persistent_entities}||{};""===e||null==e?delete i[t]:i[t]=e,this._config={...this._config,persistent_entities:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_togglePersistentEntityExpand(t){this._persistentEntityExpanded=this._persistentEntityExpanded===t?-1:t}_addPersistentEntity(){if(!this._config)return;const t={...this._config.persistent_entities}||{},e=[...t.entities||[]];e.push({entity:""}),t.entities=e,this._config={...this._config,persistent_entities:t},this._persistentEntityExpanded=e.length-1,this._dispatchConfigChanged()}_removePersistentEntity(t){if(!this._config)return;const e={...this._config.persistent_entities}||{},i=[...e.entities||[]];i.splice(t,1),e.entities=i.length>0?i:void 0,this._config={...this._config,persistent_entities:Object.keys(e).filter(t=>void 0!==e[t]).length>0?e:void 0},this._persistentEntityExpanded===t&&(this._persistentEntityExpanded=-1),this._dispatchConfigChanged()}_updatePersistentEntity(t,e,i){if(!this._config)return;const s={...this._config.persistent_entities}||{},a=[...s.entities||[]];a[t]&&(a[t][e]=i||void 0,i||delete a[t][e]),s.entities=a,this._config={...this._config,persistent_entities:s},this._dispatchConfigChanged()}_addPersistentEntityState(t){if(!this._config)return;const e={...this._config.persistent_entities}||{},i=[...e.entities||[]];if(i[t]){const e={...i[t]};e.states=[...e.states||[],{state:"",icon:"",color:""}],i[t]=e}e.entities=i,this._config={...this._config,persistent_entities:e},this._dispatchConfigChanged()}_removePersistentEntityState(t,e){if(!this._config)return;const i={...this._config.persistent_entities}||{},s=[...i.entities||[]];if(s[t]){const i={...s[t]},a=[...i.states||[]];a.splice(e,1),i.states=a.length>0?a:void 0,s[t]=i}i.entities=s,this._config={...this._config,persistent_entities:i},this._dispatchConfigChanged()}_updatePersistentEntityState(t,e,i,s){if(!this._config)return;const a={...this._config.persistent_entities}||{},o=[...a.entities||[]];if(o[t]){const a={...o[t]},n=[...a.states||[]];n[e]&&(n[e][i]=s||void 0,s||delete n[e][i]),a.states=n,o[t]=a}a.entities=o,this._config={...this._config,persistent_entities:a},this._dispatchConfigChanged()}_renderColorOptions(){const t=[];let e="";for(const i of Rt)i.category!==e&&(e=i.category,"Default"!==e&&t.push(G`
    ...
    `}_usesLegacyGridAreas(){const t=this._config?.grid?.template_areas;return!!t&&(t.includes("persistent")||t.includes("intermittent"))}_renderStatusSection(){const t=this._config?.persistent_entities?.entities?.length,e=this._config?.intermittent_entities?.entities?.length;return t||e?G`
    ...
    `:F}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i=!1!==this._config?.show_icon,s=this._config?.show_img_cell??!0,a=this._config?.icon||this._getDefaultIcon(t),o=t?this._getDomain(t.entity_id):"",n={"icon-container":!0,"with-img-cell":s,active:e,[ue(this._config?.animate_icon&&e?"pulse":void 0)]:!0},r={};if(s&&this._config?.img_cell_size&&(r.width=this._config.img_cell_size,r.height=this._config.img_cell_size),e&&s){const e=this._getEntityBackgroundColor(t);r["background-color"]=e,r.background=e}const c={};if(this._config?.icon_size&&(c["--mdc-icon-size"]=this._config.icon_size,s||(r.width=this._config.icon_size,r.height=this._config.icon_size)),e&&s)c.color="var(--text-primary-color, #fff)";else if(t&&e)if("light"===o)c.color=this._getLightIconColor(t);else if("climate"===o)c.color=this._getClimateIconColor(t);else{const e=this._getEntityStateColor(t);c.color=e||"var(--state-active-color, var(--amber-color, #ffc107))"}else if(t&&"climate"===o)c.color=this._getClimateIconColor(t);else if(t){const e=this._getEntityStateColor(t);e&&(c.color=e)}const l={};switch(this._config?.icon_horizontal_position||Dt){case Ut:l["justify-self"]="start";break;case zt:l["justify-self"]="center";break;default:l["justify-self"]="end"}switch(this._config?.icon_vertical_position||Ot){case Ot:l["align-self"]="start";break;case Nt:l["align-self"]="center";break;case Ht:l["align-self"]="end"}return G`
    ...
    `}_getEntityBackgroundColor(t){if(!t)return"var(--state-active-color, rgba(255, 167, 38, 0.3))";const e=this._getDomain(t.entity_id);if("climate"===e)switch(t.attributes.hvac_action){case"heating":case"preheating":return"var(--state-climate-heat-color, #ff8c00)";case"cooling":return"var(--state-climate-cool-color, #2196f3)";case"drying":return"var(--state-climate-dry-color, #8bc34a)";case"fan":return"var(--state-climate-fan_only-color, #00bcd4)";default:return"var(--secondary-background-color)"}if("light"===e){const e=.3,i=t.attributes.rgb_color;if(i&&Array.isArray(i)&&3===i.length)return`rgba(${i[0]}, ${i[1]}, ${i[2]}, ${e})`;const s=t.attributes.hs_color,a=t.attributes.brightness;if(s&&Array.isArray(s)&&2===s.length){const t=this._hsToRgb(s[0],s[1],a);return`rgba(${t[0]}, ${t[1]}, ${t[2]}, ${e})`}return`rgba(255, 193, 7, ${e})`}if("lock"===e){const i=ae[e]?.[t.state];if(i)return i}return"rgba(255, 167, 38, 0.3)"}_getLightIconColor(t){const e=t.attributes.rgb_color;if(e&&Array.isArray(e)&&3===e.length)return`rgb(${e[0]}, ${e[1]}, ${e[2]})`;const i=t.attributes.hs_color,s=t.attributes.brightness;if(i&&Array.isArray(i)&&2===i.length){const t=this._hsToRgb(i[0],i[1],s);return`rgb(${t[0]}, ${t[1]}, ${t[2]})`}return"var(--state-light-active-color, var(--amber-color, #ffc107))"}_getClimateIconColor(t){switch(t.attributes.hvac_action){case"heating":case"preheating":return"var(--state-climate-heat-color, #ff8c00)";case"cooling":return"var(--state-climate-cool-color, #2196f3)";case"drying":return"var(--state-climate-dry-color, #8bc34a)";case"fan":return"var(--state-climate-fan_only-color, #00bcd4)";default:return"var(--primary-text-color)"}}_hsToRgb(t,e,i){const s=e/100,a=(i??255)/255*.5,o=(1-Math.abs(2*a-1))*s,n=o*(1-Math.abs(t/60%2-1)),r=a-o/2;let c=0,l=0,d=0;return t>=0&&t<60?(c=o,l=n,d=0):t>=60&&t<120?(c=n,l=o,d=0):t>=120&&t<180?(c=0,l=o,d=n):t>=180&&t<240?(c=0,l=n,d=o):t>=240&&t<300?(c=n,l=0,d=o):t>=300&&t<360&&(c=o,l=0,d=n),[Math.round(255*(c+r)),Math.round(255*(l+r)),Math.round(255*(d+r))]}_renderClimateSection(){if(!this._config?.climate_entities&&!this._config?.power_entities)return F;const t=this._config.climate_entities,e=this._config.power_entities,i=t?.decimal_places??0,s=e?.decimal_places??0,a=!1!==t?.show_temperature_unit,o=!1!==t?.show_humidity_unit,n=!1!==t?.show_air_quality_unit,r=!1!==t?.show_illuminance_unit,c=!1!==e?.show_unit,l=this._getTemperatureValue(t,i,a),d=this._getHumidityValue(t,i,o),h=this._getAirQualityValue(t,i,n),p=this._getIlluminanceValue(t,i,r),u=this._getPowerValue(e,s,c),m=[];return d&&m.push({label:"humidity",value:d}),h&&m.push({label:"air quality",value:h}),p&&m.push({label:"illuminance",value:p}),u&&m.push({label:"power",value:u}),G`
    ...
    `}_getTemperatureValue(t,e=0,i=!0){if(!t||!this.hass)return null;if(t.primary_entity){const s=this.hass.states[t.primary_entity];if(s&&!this._isUnavailable(s)){const t=parseFloat(s.state);if(!isNaN(t)){const a=i&&s.attributes.unit_of_measurement||"°";return`${t.toFixed(e)}${a}`}}}if(t.temperature_entities&&t.temperature_entities.length>0){const s=this._calculateAverage(t.temperature_entities,e);if(null!==s.value){const t=i&&s.unit||"°";return`${s.value}${t}`}}return null}_getHumidityValue(t,e=0,i=!0){if(!t?.humidity_entities||0===t.humidity_entities.length||!this.hass)return null;const s=this._calculateAverage(t.humidity_entities,e);if(null!==s.value){const t=i?"%":"";return`${s.value}${t}`}return null}_getAirQualityValue(t,e=0,i=!0){if(!t?.air_quality_entities||0===t.air_quality_entities.length||!this.hass)return null;const s=this._calculateAverage(t.air_quality_entities,e);if(null!==s.value){const t=i&&s.unit?` ${s.unit}`:"";return`${s.value}${t}`}return null}_getIlluminanceValue(t,e=0,i=!0){if(!t?.illuminance_entities||0===t.illuminance_entities.length||!this.hass)return null;const s=this._calculateAverage(t.illuminance_entities,e);if(null!==s.value){const t=i?" lx":"";return`${s.value}${t}`}return null}_getPowerValue(t,e=0,i=!0){if(!t?.entities||0===t.entities.length||!this.hass)return null;let s=0,a=0;for(const e of t.entities){const t=this.hass.states[e];if(!t||this._isUnavailable(t))continue;const i=parseFloat(t.state);if(isNaN(i))continue;const o=t.attributes.unit_of_measurement,n=("string"==typeof o?o:"W").toLowerCase();s+="kw"===n?1e3*i:"mw"===n?1e6*i:"gw"===n?1e9*i:i,a++}if(0===a)return null;if(s>=1e3){const t=(s/1e3).toFixed(e);return i?`${t}kW`:t}const o=s.toFixed(e);return i?`${o}W`:o}_calculateAverage(t,e=1){if(!this.hass)return{value:null,unit:"",count:0};const i=[];let s="";for(const e of t){const t=this.hass.states[e];if(!t||this._isUnavailable(t))continue;const a=parseFloat(t.state);isNaN(a)||(i.push(a),!s&&t.attributes.unit_of_measurement&&(s=t.attributes.unit_of_measurement))}if(0===i.length)return{value:null,unit:"",count:0};const a=i.reduce((t,e)=>t+e,0)/i.length;return{value:parseFloat(a.toFixed(e)),unit:s,count:i.length}}_isUnavailable(t){return["unavailable","unknown"].includes(t.state)}_renderPersistentEntities(t=!1){if(!this._config?.persistent_entities?.entities?.length||!this.hass)return F;const e=this._config.persistent_entities,i=e.position||"right",s=e.icon_size||"21px",a={gap:e.gap||"4px"};if(t){if(e.padding)a.padding=e.padding;else switch(i){case"left":a.padding="0 0 1px 14px";break;case"center":a.padding="0 0 1px 0";break;default:a.padding="0 0 1px 2px",e.margin||(a.margin="0 3px 0 0")}switch(e.margin&&(a.margin=e.margin),i){case"left":a["justify-self"]="start";break;case"center":a["justify-self"]="center";break;default:a["justify-self"]="end"}}const o=e.entities||[];return G`
      <div class=${_t({"persistent-section":!0,"legacy-grid":t})} style=${wt(a)}>
        ${o.map(t=>this._renderPersistentEntity(t,s))}
      </div>
    `}_renderPersistentEntity(t,e){const i=this.hass?.states[t.entity],s=!i||this._isUnavailable(i),a=i?.state||"unavailable",o=t.entity.split(".")[0],n=t.states?.find(t=>t.state===a);let r=n?.icon||t.icon;!r&&i?.attributes.icon&&(r=i.attributes.icon),r||(r=this._getPersistentEntityDefaultIcon(o,a));let c=n?.color;c||(c=this._getPersistentEntityColor(o,a,s));const l=t.icon_size||e,d={width:l,height:l,color:c,"--mdc-icon-size":l};return G`
      <div 
        ...
        title="${i?.attributes.friendly_name||t.entity}: ${a}"
      >
        <ha-icon
          .icon=${r}
          style=${wt(d)}
