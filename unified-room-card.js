...
`;let Te=class extends ct{constructor(){super(...arguments),this._accordionState={main:!0,mainBasic:!0,mainIcon:!1,mainAppearance:!1,mainActions:!1,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1,this._intermittentEntityExpanded=-1,this._customColorInputs=new Set,this._intermittentCustomColorInputs=new Set,this._showUnavailableCustomColorInput=!1}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
    ...
    `}_renderPersistentEntityConfig(t,e){const i=t.entity||"",a=i&&this.hass?.states[i],n=i?i.split(".")[0]:"",s=le.includes(n);return W`
    ...
    `}_renderIntermittentEntityConfig(t,e){const i=t.entity||"",a=i&&this.hass?.states[i],n=i?i.split(".")[0]:"",s=le.includes(n);return W`
      <div class="entity-row">
    ...
    `}_addGlowEffect(){if(!this._config)return;const t=[...this._config.glow_effects||[]];t.push({entity:"",states:[],color:"auto",spread:4,animation:"none"}),this._config={...this._config,glow_effects:t},this._dispatchConfigChanged()}_updateGlowEffect(t,e,i){if(!this._config?.glow_effects)return;const a=[...this._config.glow_effects];a[t]={...a[t],[e]:i},this._config={...this._config,glow_effects:a},this._dispatchConfigChanged()}_removeGlowEffect(t){if(!this._config?.glow_effects)return;const e=[...this._config.glow_effects];e.splice(t,1),this._config={...this._config,glow_effects:e.length>0?e:void 0},this._dispatchConfigChanged()}_dispatchConfigChanged(){const t=new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0});this.dispatchEvent(t)}};function De(t){return["unavailable","unknown"].includes(t.state)}function Be(t,e,i=1){const a=[];let n="";for(const i of e){const e=t.states[i];if(!e||De(e))continue;const s=parseFloat(e.state);isNaN(s)||(a.push(s),!n&&e.attributes.unit_of_measurement&&(n=e.attributes.unit_of_measurement))}if(0===a.length)return{value:null,unit:"",count:0};const s=a.reduce((t,e)=>t+e,0)/a.length;return{value:parseFloat(s.toFixed(i)),unit:n,count:a.length}}function je(t,e,i){if(!e&&!i)return F;const a=e?.decimal_places??0,n=i?.decimal_places??0,s=!1!==e?.show_primary_unit,o=!1!==e?.show_temperature_unit,r=!1!==e?.show_humidity_unit,l=!1!==e?.show_air_quality_unit,c=!1!==e?.show_illuminance_unit,d=!1!==i?.show_unit;let h=null;e?.primary_entities&&e.primary_entities.length>0&&(h=function(t,e,i=0,a=!0){if(!e?.primary_entities||0===e.primary_entities.length)return null;const n=Be(t,e.primary_entities,i);return null===n.value?null:a&&n.unit?`${n.value}${n.unit}`:String(n.value)}(t,e,a,s)),h||(h=function(t,e,i=0,a=!0){if(!e?.temperature_entities||0===e.temperature_entities.length)return null;const n=Be(t,e.temperature_entities,i);if(null!==n.value){const t=a&&n.unit||"°";return`${n.value}${t}`}return null}(t,e,a,o));const p=function(t,e,i=0,a=!0){if(!e?.humidity_entities||0===e.humidity_entities.length)return null;const n=Be(t,e.humidity_entities,i);if(null!==n.value){const t=a?"%":"";return`${n.value}${t}`}return null}(t,e,a,r),u=function(t,e,i=0,a=!0){if(!e?.air_quality_entities||0===e.air_quality_entities.length)return null;const n=Be(t,e.air_quality_entities,i);if(null!==n.value){const t=a&&n.unit?n.unit:"";return`${n.value}${t}`}return null}(t,e,a,l),m=function(t,e,i=0,a=!0){if(!e?.illuminance_entities||0===e.illuminance_entities.length)return null;const n=Be(t,e.illuminance_entities,i);if(null!==n.value){const t=a?"lx":"";return`${n.value}${t}`}return null}(t,e,a,c),f=function(t,e,i=0,a=!0){if(!e?.entities||0===e.entities.length)return null;let n=0,s=0;for(const i of e.entities){const e=t.states[i];if(!e||De(e))continue;const a=parseFloat(e.state);if(isNaN(a))continue;const o=e.attributes.unit_of_measurement,r=("string"==typeof o?o:"W").toLowerCase();n+="kw"===r?1e3*a:"mw"===r?1e6*a:"gw"===r?1e9*a:a,s++}if(0===s)return null;if(n>=1e3){const t=(n/1e3).toFixed(i);return a?`${t}kW`:t}const o=n.toFixed(i);return a?`${o}W`:o}(t,i,n,d),g=[];return p&&g.push({label:"humidity",value:p}),u&&g.push({label:"air quality",value:u}),m&&g.push({label:"illuminance",value:m}),f&&g.push({label:"power",value:f}),W`
  ...
  `}function Ne(t){const e=parseFloat(t.state);return isNaN(e)?null:e}function Oe(t){return null===t?"mdi:battery-unknown":t<=10?"mdi:battery-alert":t<=20?"mdi:battery-10":t<=30?"mdi:battery-20":t<=40?"mdi:battery-30":t<=50?"mdi:battery-40":t<=60?"mdi:battery-50":t<=70?"mdi:battery-60":t<=80?"mdi:battery-70":t<=90?"mdi:battery-80":"mdi:battery"}function He(t,e){const i=e.low_threshold??20,a=e.entities||[],n=[];for(const e of a){const a=t.states[e];if(!a)continue;const s=Ne(a);null!==s&&s<=i&&n.push(e)}return n}function Me(t,e,i){if(!e)return F;if(e.show_as_badge)return F;const a=He(t,e);if(0===a.length)return F;const n=e.icon_size||"21px";return W`
    ${a.map(a=>function(t,e,i,a,n,s){const o=t.states[e];if(!o)return F;const r=Ne(o),l=Oe(r),c={"--mdc-icon-size":i,color:"var(--state-sensor-battery-low-color, var(--error-color, #db4437))"},d=n.tap_action||{action:"more-info"},h=n.hold_action||{action:"more-info"};return W`
    <div 
  ...
  `}(t,a,n,0,e,i))}
  `}function Le(t,e){return e?He(t,e).length:0}Te.styles=Ue,t([mt({attribute:!1}),e("design:type",Object)],Te.prototype,"hass",void 0),t([ft(),e("design:type",Object)],Te.prototype,"_config",void 0),t([ft(),e("design:type",Object)],Te.prototype,"_accordionState",void 0),t([ft(),e("design:type",Number)],Te.prototype,"_persistentEntityExpanded",void 0),t([ft(),e("design:type",Number)],Te.prototype,"_intermittentEntityExpanded",void 0),t([ft(),e("design:type",Set)],Te.prototype,"_customColorInputs",void 0),t([ft(),e("design:type",Set)],Te.prototype,"_intermittentCustomColorInputs",void 0),t([ft(),e("design:type",Boolean)],Te.prototype,"_showUnavailableCustomColorInput",void 0),Te=t([ht(Ct)],Te);const Ge="mdi:update";function Re(t,e){const i=e.entities||[],a=[];for(const e of i){const i=t.states[e];i&&"on"===i.state&&a.push(e)}return a}function Ve(t,e){if(0===e.length)return"";if(1===e.length){const i=t.states[e[0]];return i?`${i.attributes.friendly_name||e[0]}: Update ${i.attributes.latest_version||"available"}`:"1 update available"}const i=e.map(e=>{const i=t.states[e];return i?.attributes.friendly_name||e});return`${e.length} updates available:\n${i.join("\n")}`}function We(t,e,i,a){if(!e)return F;if(e.show_as_badge)return F;const n=Re(t,e);if(0===n.length)return F;const s=e.icon_size||"21px",o=e.color||"var(--state-update-active-color, var(--info-color, #039be5))",r=e.icon||Ge,l=!0===e.spin_animation,c={"--mdc-icon-size":s,color:o},d=e.tap_action||{action:"more-info"},h=e.hold_action||{action:"more-info"},p=n[0],u=Ve(t,n),m={"update-icon":!0,"spin-animation":l&&a.isSpinning};return W`
    <div 
      class="intermittent-entity"
  ...
  `}function qe(t,e){return e?Re(t,e).length:0}var Fe;l`
  @keyframes spin {
    from {
      transform: rotate(0deg);
    }
...
`,console.info(`%c ${$t.toUpperCase()} %c v2.0.2-u4 `,"color: white; background: #3498db; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #3498db; background: #ecf0f1; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");let Ze=Fe=class extends ct{constructor(){super(...arguments),this._tapCount=0,this._updateAnimationState={isSpinning:!1}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={show_name:!0,show_icon:!0,show_state:!1,show_img_cell:!0,icon_animation:"none",tap_action:{action:"toggle"},hold_action:{action:"none"},double_tap_action:{action:"more-info"},...t}}getCardSize(){return 2}disconnectedCallback(){super.disconnectedCallback(),this._tapTimeout&&(clearTimeout(this._tapTimeout),this._tapTimeout=void 0),this._stopUpdateSpinTimer()}_startUpdateSpinTimer(){if(this._stopUpdateSpinTimer(),t=this._config?.update_entities,!0!==t?.spin_animation)return;var t;if(!this.hass||0===qe(this.hass,this._config?.update_entities))return;const e=function(t){const e=t?.spin_interval??60;return 1e3*Math.max(10,e)}(this._config?.update_entities);this._triggerUpdateSpin(),this._updateSpinTimer=setInterval(()=>{this._triggerUpdateSpin()},e)}_stopUpdateSpinTimer(){this._updateSpinTimer&&(clearInterval(this._updateSpinTimer),this._updateSpinTimer=void 0),this._spinAnimationTimeout&&(clearTimeout(this._spinAnimationTimeout),this._spinAnimationTimeout=void 0)}_triggerUpdateSpin(){this._updateAnimationState={isSpinning:!0},this._spinAnimationTimeout=setTimeout(()=>{this._updateAnimationState={isSpinning:!1}},1e3)}static getConfigElement(){return document.createElement(Ct)}static getStubConfig(){return{type:`custom:${xt}`,name:"Room Name",entity:"",show_name:!0,show_icon:!0}}updated(t){super.updated(t),this._config?.grid_area?this.style.gridArea=this._config.grid_area:this.style.removeProperty("grid-area"),(t.has("hass")||t.has("_config"))&&(t.get("hass")&&!t.has("_config")||this._startUpdateSpinTimer())}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("_updateAnimationState"))return!0;if(t.has("hass")&&this._config){const e=t.get("hass");return!e||this._hasRelevantStateChanged(e)}return!1}_hasRelevantStateChanged(t){if(!this._config||!this.hass)return!1;const e=[];if(this._config.entity&&e.push(this._config.entity),this._config.entities?.length&&e.push(...this._config.entities),this._config.persistent_entities?.entities&&e.push(...this._config.persistent_entities.entities.map(t=>t.entity)),this._config.intermittent_entities?.entities&&e.push(...this._config.intermittent_entities.entities.map(t=>t.entity)),this._config.climate_entities){const t=this._config.climate_entities;t.primary_entities&&e.push(...t.primary_entities),t.temperature_entities&&e.push(...t.temperature_entities),t.humidity_entities&&e.push(...t.humidity_entities),t.air_quality_entities&&e.push(...t.air_quality_entities),t.illuminance_entities&&e.push(...t.illuminance_entities)}this._config.power_entities?.entities&&e.push(...this._config.power_entities.entities),this._config.battery_entities?.entities&&e.push(...this._config.battery_entities.entities),this._config.update_entities?.entities&&e.push(...this._config.update_entities.entities),this._config.glow_effects?.length&&e.push(...this._config.glow_effects.map(t=>t.entity).filter(Boolean));for(const i of e)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this._config||!this.hass)return F;const t=this._getPrimaryEntity(),e=this._isGroupActive(),i=this._getBorderStyle(),a=this._getActiveGlowEffect(),n=this._isPrimaryEntityUnavailable(),s=this._getUnavailableConfig(),o=n&&"off"!==s.behavior,r=function(t){const e=[];if(t.cardHeight&&e.push(`height: ${t.cardHeight};`),t.cardWidth&&e.push(`width: ${t.cardWidth};`),t.gridTemplateAreas&&e.push(`grid-template-areas: ${t.gridTemplateAreas};`),t.gridTemplateColumns&&e.push(`grid-template-columns: ${t.gridTemplateColumns};`),t.gridTemplateRows&&e.push(`grid-template-rows: ${t.gridTemplateRows};`),t.backgroundGradient?e.push(`background: ${t.backgroundGradient};`):t.backgroundColor&&e.push(`background-color: ${t.backgroundColor};`),t.borderStyle&&e.push(`border: ${t.borderStyle};`),t.glowColor){const i=t.glowSpread??4;e.push(`--glow-color: ${t.glowColor};`),e.push(`--glow-spread: ${i}px;`)}return void 0!==t.unavailableOpacity&&e.push(`opacity: ${t.unavailableOpacity};`),e.join(" ")}({cardHeight:this._config.card_height,cardWidth:this._config.card_width,gridTemplateAreas:this._config.grid?.template_areas,gridTemplateColumns:this._config.grid?.template_columns,gridTemplateRows:this._config.grid?.template_rows,backgroundColor:this._config.background_color,activeBackgroundColor:e?this._config.active_background_color:void 0,backgroundGradient:this._config.background_gradient,borderStyle:i,glowColor:a?.color,glowSpread:a?.spread,glowAnimation:a?.animation,unavailableOpacity:o?s.opacity:void 0}),l={"state-on":e&&!o,"state-off":!e&&!!t&&!o,"state-unavailable":o};a&&!o&&("pulse"===a.animation?l["card-glow-pulse"]=!0:"breathe"===a.animation?l["card-glow-breathe"]=!0:l["card-glow"]=!0);const c=this._getDefinedGridAreas();return W`
      ...
      >
        ...
        ${this.hass?je(this.hass,this._config?.climate_entities,this._config?.power_entities):F}
    ...
    `}_renderBatterySection(){return this.hass&&this._config?.battery_entities?0===Le(this.hass,this._config.battery_entities)?F:W`
      <div class="battery-section legacy-grid">
        ${Me(this.hass,this._config.battery_entities,this._handleEntityAction.bind(this))}
      </div>
    `:F}_renderUpdateSection(){return this.hass&&this._config?.update_entities?0===qe(this.hass,this._config.update_entities)?F:W`
      <div class="update-section legacy-grid">
        ${We(this.hass,this._config.update_entities,this._handleEntityAction.bind(this),this._updateAnimationState)}
      </div>
    `:F}_renderBatteryBadge(){return this.hass&&this._config?.battery_entities?(t=this._config.battery_entities,!0!==t?.show_as_badge?F:function(t,e,i){if(!e||!e.show_as_badge)return F;const a=He(t,e);if(0===a.length)return F;let n=null;for(const e of a){const i=t.states[e];if(i){const t=Ne(i);null!==t&&(null===n||t<n)&&(n=t)}}const s=Oe(n),o=e.badge_size||ce,r=e.badge_icon_size||de,l=e.badge_position||fe,c=e.badge_color||"var(--state-sensor-battery-low-color, var(--error-color, #db4437))",d={...function(t){switch(t){case pe:return{top:"-10px",left:"-10px",right:"auto",bottom:"auto"};case ue:return{top:"auto",left:"auto",right:"-10px",bottom:"-10px"};case me:return{top:"auto",left:"-10px",right:"auto",bottom:"-10px"};default:return{top:"-10px",left:"auto",right:"-10px",bottom:"auto"}}}(l),width:o,height:o,"background-color":c},h={"--mdc-icon-size":r,color:"white"},p=e.tap_action||{action:"more-info"},u=e.hold_action||{action:"more-info"},m=a[0],f=function(t,e){if(0===e.length)return"";if(1===e.length){const i=t.states[e[0]];return i?`${i.attributes.friendly_name||e[0]}: ${Ne(i)}%`:"1 low battery"}const i=e.map(e=>{const i=t.states[e];return`${i?.attributes.friendly_name||e}: ${Ne(i)}%`});return`${e.length} low batteries:\n${i.join("\n")}`}(t,a);return W`
    <div 
  ...
  `}(this.hass,this._config.battery_entities,this._handleEntityAction.bind(this))):F;var t}_renderUpdateBadge(){return this.hass&&this._config?.update_entities?(t=this._config.update_entities,!0!==t?.show_as_badge?F:function(t,e,i,a){if(!e||!e.show_as_badge)return F;const n=Re(t,e);if(0===n.length)return F;const s=e.icon||Ge,o=e.badge_size||ce,r=e.badge_icon_size||de,l=e.badge_position||fe,c=e.badge_color||"var(--state-update-active-color, var(--info-color, #039be5))",d=!0===e.spin_animation,h={...function(t){switch(t){case pe:return{top:"-10px",left:"-10px",right:"auto",bottom:"auto"};case ue:return{top:"auto",left:"auto",right:"-10px",bottom:"-10px"};case me:return{top:"auto",left:"-10px",right:"auto",bottom:"-10px"};default:return{top:"-10px",left:"auto",right:"-10px",bottom:"auto"}}}(l),width:o,height:o,"background-color":c},p={"--mdc-icon-size":r,color:"white"},u={"update-icon":!0,"spin-animation":d&&a.isSpinning},m=e.tap_action||{action:"more-info"},f=e.hold_action||{action:"more-info"},g=n[0],v=Ve(t,n);return W`
    <div 
  ...
  `}(this.hass,this._config.update_entities,this._handleEntityAction.bind(this),this._updateAnimationState)):F;var t}_renderStatusSection(){const t=this._config?.persistent_entities?.entities?.length,e=this._config?.intermittent_entities?.entities?.length,i=this._config?.battery_entities,a=this._config?.update_entities,n=this.hass?Le(this.hass,this._config?.battery_entities):0,s=this.hass?qe(this.hass,this._config?.update_entities):0;return t||e||0!==n||0!==s?W`
      <div class="status-section">
        ${this._renderPersistentEntities(!1)}
        ${this._renderIntermittentEntities(!1,!1,!1)}
        ${i&&this.hass?Me(this.hass,this._config?.battery_entities,this._handleEntityAction.bind(this)):F}
        ${a&&this.hass?We(this.hass,this._config?.update_entities,this._handleEntityAction.bind(this),this._updateAnimationState):F}
      </div>
